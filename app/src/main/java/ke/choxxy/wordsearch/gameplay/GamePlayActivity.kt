...
import ke.choxxy.wordsearch.SoundPlayer
...
import ke.choxxy.wordsearch.gameover.GameoverDialog.GameOverDialogInputListener
import ke.choxxy.wordsearch.gameplay.GamePlayViewModel.AnswerResult
import ke.choxxy.wordsearch.gameplay.GamePlayViewModel.GameState
import ke.choxxy.wordsearch.gameplay.GamePlayViewModel.Generating
import ke.choxxy.wordsearch.gameplay.GamePlayViewModel.Paused
import ke.choxxy.wordsearch.gameplay.GamePlayViewModel.Playing
import ke.choxxy.wordsearch.gameplay.GamePlayViewModel.Update
...
class GamePlayActivity : FullscreenActivity(), GameOverDialogInputListener {
    ...
    companion object {
        const val EXTRA_GAME_ROUND_ID = "ke.choxxy.wordsearch.gameplay.GamePlayActivity.ID"
        const val EXTRA_ROW_COUNT = "ke.choxxy.wordsearch.gameplay.GamePlayActivity.ROW"
        const val EXTRA_COL_COUNT = "ke.choxxy.wordsearch.gameplay.GamePlayActivity.COL"
        const val EXTRA_GAME_DATA =
            "ke.choxxy.wordsearch.gameplay.GamePlayActivity.GAME_DATA"
