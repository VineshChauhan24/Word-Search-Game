...
import ke.choxxy.wordsearch.features.gameover.GameoverDialog;
...
import ke.choxxy.wordsearch.custom.StreakView;
...
public class GamePlayActivity extends FullscreenActivity implements GameoverDialog.GameOverDialogInputListener {

    public static final String EXTRA_GAME_ROUND_ID =
            "ke.choxxy.wordsearch.features.gameplay.GamePlayActivity.ID";
    public static final String EXTRA_ROW_COUNT =
            "ke.choxxy.wordsearch.features.gameplay.GamePlayActivity.ROW";
    public static final String EXTRA_COL_COUNT =
            "ke.choxxy.wordsearch.features.gameplay.GamePlayActivity.COL";
...
//                    .start();
    ...
    /*    Intent intent = new Intent(this, GameOverActivity.class);
        ...
        finish();*/
            ...
            GameoverDialog editNameDialogFragment = GameoverDialog.newInstance("Some Title");
    ...
    public void sendInput(String input) {
        if(input.equals(GameoverDialog.ACTION_MAIN_MENU)){
